...
export class drji extends ethereum.SmartContract {
  static bind(address: Address): drji {
    return new drji("drji", address);
  }
  ...
  try_mint(_address: Address): ethereum.CallResult<BigInt> {
